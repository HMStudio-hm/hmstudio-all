// all.js - HMStudio Combined Features v1.1.2
...
;(() => {
  ...
  const params = (() => {
    ...
    const smartCartParam = urlParams.get("smartCart")
    const campaignsParam = urlParams.get("campaigns")
    return {
      smartCart: smartCartParam === "true",
  ...
  if (params.smartCart) {
    ...
    const SmartCart = {
      ...
      createCountdownTimer(campaign, productId) {
        ...
        const timerText = getCurrentLanguage() === "ar" ? campaign.timerSettings.textAr : campaign.timerSettings.textEn
